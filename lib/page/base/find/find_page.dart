    ...
    try {
      ...
      setState(() {
        courses = (data['courses'] as List)
            ...
            .toList();
        joinedCourses = (data['courses'] as List)
            .map((json) => Course.fromJson(json))
            .toList();
    ...
    return Scaffold(
      ...
      body: LoaderOverlay(
        child: TabBarView(
          ...
          controller: _tabController,
          children: [
            _buildCoursesTab(courses, "No courses found.", true),  // Pass `true` for Created Courses tab
            _buildCoursesTab(joinedCourses, "No users found.", false),   // Pass `false` for Joined Courses tab
            // _buildMyCoursesTab(),
